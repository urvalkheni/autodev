...
export default function MernTemplatePage() {
  ...
  useEffect(() => {
    trackTemplateView("mern");
  }, []);

  const handleCopy = () => {
    navigator.clipboard.writeText("autodev create mern-stack my-mern-app");
    setCopied(true);
    trackTemplateCopy("mern");
      ...
      <div className="flex-1 pt-32 pb-24 px-6 max-w-5xl mx-auto w-full">
        ...
        <script
          ...
          dangerouslySetInnerHTML={{
            __html: JSON.stringify({
              ...
              name: "AutoDev MERN Stack Docker Starter Template",
              description:
                "Dockerized MERN Stack starter boilerplate containing React Vite client, Express Node API server, and MongoDB configurations.",
              programmingLanguage: "JavaScript, TypeScript",
              runtimePlatform: "Node.js, MongoDB",
              targetProduct: {
        ...
        <div className="mb-8 text-center md:text-left">
          <span className="inline-flex items-center gap-1.5 px-3 py-1 border border-emerald-500/30 bg-emerald-500/10 text-emerald-400 text-xs font-bold uppercase tracking-wider rounded-full">
            <Sparkles className="w-3 h-3" /> Fullstack Docker Boilerplate
          </span>
        </div>
        ...
        <div className="text-center md:text-left mb-12">
          ...
          <p className="text-lg md:text-xl text-slate-400 max-w-3xl leading-relaxed">
            ...
            instantly. Fully pre-linked via docker-compose for unified local
            launches and simplified configurations.
          </p>
        </div>
        ...
        <div className="mb-16 max-w-2xl">
          ...
          <div className="terminal w-full p-4 bg-[#0d0d0d] border-2 border-[#2A2A2A] relative flex items-center justify-between font-mono text-sm text-[#00FF87]">
            <div className="flex items-center gap-2 overflow-x-auto pr-8">
              ...
              <span>autodev create mern-stack my-mern-app</span>
            </div>
            <button
              onClick={handleCopy}
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            <div className="bg-[#111] border-2 border-[#2A2A2A] p-6">
              ...
              <p className="text-xs text-slate-400 leading-relaxed">
                Node.js and Express backend server pre-linked to Mongoose
                database helper layers with standard API response handlers.
              </p>
            </div>
            <div className="bg-[#111] border-2 border-[#2A2A2A] p-6">
              ...
              <p className="text-xs text-slate-400 leading-relaxed">
                Vite TypeScript client dashboard configured with modern
                components, routing templates, and styled layout templates.
              </p>
            </div>
            <div className="bg-[#111] border-2 border-[#2A2A2A] p-6">
              ...
              <p className="text-xs text-slate-400 leading-relaxed">
                A unified `docker-compose.yml` linking database server, server
                APIs, and static client nginx containers seamlessly.
              </p>
            </div>
          </div>
        </div>
        ...
        <div className="bg-[#111] border-2 border-[#2A2A2A] p-8">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-3 gap-6 text-left">
            ...
            <div>
              ...
              <p className="text-[10px] text-[#555]">Instead of 55 prompts</p>
            </div>
            <div>
              <p className="text-xs text-[#666] uppercase">Tokens Consumed</p>
              <p className="text-2xl font-black text-emerald-400">18,000</p>
              <p className="text-[10px] text-[#555]">
                87% savings ($0.20 cost)
              </p>
            </div>
          </div>
        </div>
